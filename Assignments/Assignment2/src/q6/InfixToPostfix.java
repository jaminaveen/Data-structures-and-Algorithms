...
public class InfixToPostfix 
{
	...
	public static void main(String[] args) throws IOException 
	{
		...
		System.out.println("Postfix is " + ip1.doTrans("(1 + 2 * (20 / 5)) ") );
		InfixToPostfix ip2 = new InfixToPostfix();
		System.out.println("Postfix is " + ip2.doTrans("(1 + 3 + ((4 / 2) * (8 * 4) )) ") );
		InfixToPostfix ip3 = new InfixToPostfix();
		System.out.println("Postfix is " + ip3.doTrans("(4 + 8) * (6 - 5)/ ((3 - 2) * (2 + 2)) ") );
	}
